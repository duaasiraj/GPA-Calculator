...
try:
    while True:
        ...
        while True:
            TotalMarks = int(input("Enter total marks for your test: [enter -1 to stop] "))
            if TotalMarks == -1:
                break
            Yourmarks = int(input("Enter your score for the test: "))
        ...
        print("Weighted Percentage =", percent)
        print("Course GPA =", course_gpa)
